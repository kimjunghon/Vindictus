...
namespace Engine
{
	...
	enum class SHADER_DEFFERRED { DEBUG, DIRECTIONAL, POINT, COMBINED, BLUR_X, BLUR_Y, DISTORTION};
	enum class RENDERGROUP { PRIORITY, SHADOW, NONBLEND, EMISSIVE, DISTORTION, BLUR, NONLIGHT, BLEND, UI, MAP_SHADOW, FONT, END };
	...
	enum class COLLIDER_TYPE { NONE, OVERLAP, BLOCK, END};
