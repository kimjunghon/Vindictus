...
namespace Client
{
	...
	enum class PLAYER_STATE { IDLE, MOVE, ATTACK, SMASH0, SMASH1, SMASH2, SMASH3, SMASH4, GUARD, GUARD_COUNTER, HEAVYSTAND, ROLL, HIT, END};
	enum class HIT_TYPE		{ FRONT, BACK, RIGHT, LEFT, STRONG, GAURD, HEAVYSTAND, END};
