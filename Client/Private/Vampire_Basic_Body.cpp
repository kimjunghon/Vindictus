...
HRESULT CVampire_Basic_Body::Render_Shadow()
{
...
HRESULT CVampire_Basic_Body::Bind_ShaderResources_Dissolve()
{
	if (FAILED(m_pShaderCom->Bind_Matrix("g_WorldMatrix", m_pPawnMatrix)))
		return E_FAIL;
	...
	if(FAILED(m_pDissolveTexture->Bind_Shader_Texture(m_pShaderCom, "g_DissolveTexture", 3)))
		return E_FAIL;
