...
HRESULT CVampire_Basic::Initialize_Prototype()
{
    ...
    CMonster::Ready_Status("../Bin/Resources/StatusData/Vampire_Basic_Status.json");
...
HRESULT CVampire_Basic::Initialize(void* pArg)
{
    ...
    if (FAILED(CVampire::Ready_VampireTrailNotifY("../Bin/Resources/AnimDatas/Vampire_Basic_Trail_AnimDatas.json")))
        return E_FAIL;
