...
void CQueenAnimMachine::Initialize_IDLE()
{
	...
	m_AnimDatas[iFlag] = {"Idle", false, _float2(1.f, 1.f), 2.f};
...
void CQueenAnimMachine::Initialize_ATTACK()
{
	...
	m_AnimDatas[iFlag | ENUM_CLASS(ATTACK_FLAG::LEFTHAND)] = { "Attack_LeftHand", false, _float2(1.f, 1.f), 2.f };
	m_AnimDatas[iFlag | ENUM_CLASS(ATTACK_FLAG::RIGHTHAND)] = { "Attack_RightHand", false, _float2(1.f, 1.f), 2.f };
...
void CQueenAnimMachine::Initialize_HIT()
{
	...
	m_AnimDatas[iFlag | ENUM_CLASS(HIT_FLAG::DAMAGE)] = { "Damage", false, _float2(1.f, 1.f), 2.f };
